...
export function getSelectionPositionsInElement(element: HTMLElement, range: Range): { start: number; end: number } {
...
export function applyFormattingToRange(element: HTMLElement, startPos: number, endPos: number, formatting: Formatting): void {
...
function splitAndWrapTextNode(textNode: Text, startOffset: number, endOffset: number, formatting: Formatting): void {
    if (!textNode.parentNode) return;
...
export function applyFormattingStyles(el: HTMLElement, formatting: Formatting): void {
...
export function extractFormattingRangesFromBlock(blockEl: HTMLElement): FormattingRange[] {
